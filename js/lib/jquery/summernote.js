...
(function (factory) {
    ...
    lang: {
      'en-US': {
        ...
        video: {
          ...
          insert: 'Insert Video',
          url: 'Video URL?',
          providers: '(GTV, YouTube, Vimeo, Vine, Instagram, DailyMotion or Youku)'
        },
        table: {
          table: 'Table'
        },
  ...
  var Editor = function () {
    ...
    this.insertVideo = function ($editable, sUrl) {
      // video url patterns(GTV, youtube, instagram, vimeo, dailymotion, youku)
	  var gtvRegExp = /^http(s)?:\/\/(.*)\/#!\/videos\/(\d+)/;
      var gtvMatch = sUrl.match(gtvRegExp);
      ...
      } else if (gtvMatch && gtvMatch[3].length) {  
        $video = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
          .attr('height', '300')
          .attr('width', '560')
          .attr('src', '//' + gtvMatch[2] + '/embed/' + gtvMatch[3] + '/1');
      } else {
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      //01. create Editor
      var $editor = $('<div class="note-editor no-bor"></div>');
      if (options.width) {
      ...
      var $editable = $('<div class="note-editable form-control top-mar" contentEditable="' + isContentEditable + '"></div>')
          .prependTo($editor);
      if (options.height) {
      ...
      toolbarHTML = '<div class="note-toolbar btn-toolbar no-bor no-pad no-bg">' + toolbarHTML + '</div>';
