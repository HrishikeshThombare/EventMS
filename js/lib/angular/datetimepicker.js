      ...
      link: function (scope, element, attrs) {
        ...
        var dataFactory = {
          ...
          day: function (unixDate) {
            ...
            var activeDate = scope.ngModel ? moment(scope.ngModel).format('yyyy-MM-dd') : '';
          ...
          hour: function (unixDate) {
            ...
            var activeFormat = scope.ngModel ? moment(scope.ngModel).format('yyyy-MM-dd') : '';
          ...
          setTime: function (unixDate) {
			...
			var sd = newDate.getFullYear()+'-'+ newDate.getMonth()+1 +'-'+ newDate.getDate();
            scope.ngModel = sd;
