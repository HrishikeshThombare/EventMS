...
(function () {
    ...
    app.directive("ngAnalyticsAuth", [
        '$rootScope',
        'ngAnalyticsService',
        function ($rootScope, ngAnalyticsService) {
            return {
                scope: {
                    label: '@',
                    authContainer: '@',
    ...
    app.run([
        ...
        function ($templateCache, $timeout, ngAnalyticsService) {
            ...
            $templateCache.put('ngAnalytics-chart/template.html', '<div id="{{chart.chart.container}}" class="thumbnail space top-mar right-mar-sm left-mar-sm bottom-mar"></div>');
