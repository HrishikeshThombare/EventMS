...
(function (factory) {
    ...
    angular.module('blueimp.fileupload', [])
        ...
        .controller('FileUploadController', [
            '$scope', '$rootScope', '$element', '$attrs', '$window', 'fileUpload',
            function ($scope, $rootScope, $element, $attrs, $window, fileUpload) {
                var uploadMethods = {
                    progress: function () {
                ...
                $scope.clear = function (files) {
					$rootScope.fileUploaded = $rootScope.fileUploaded - 1;
