...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    .constant('satellizer.config', {
      ...
      providers: {
        ...
        facebook: {
          ...
          redirectUri: window.location.origin + '/' || window.location.protocol + '//' + window.location.host,
          scope: ['email','public_profile','user_birthday','user_friends','user_likes','user_videos'],
          scopeDelimiter: ',',
          requiredUrlParams: ['display', 'scope', 'user_birthday'],
          display: 'popup',
          type: '2.0',
    ...
    .factory('satellizer.popup', [
      ...
      'satellizer.utils',
	  'deviceDetector',
      function($q, $interval, $window, $location, utils, deviceDetector) {
          ...
          polling = $interval(function() {
            try {
              if (popupWindow.document.domain === document.domain && (popupWindow.location.search || popupWindow.location.hash)) {
				...
				if (deviceDetector.isDesktop() === false) {
